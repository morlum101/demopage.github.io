...
function isApproved(status) {
    if (status === 0) {
        ...
        return `<span class='badge badge-soft-success'>Approved <i class='fas fa-check-circle ml-1'></i></span>`;
    } else {
        return `<span class='badge badge-soft-danger'>Canceled <i class='fas fa-times-circle ml-1'></i></span>`;
    }
}
...
function isActivated(bool) {
    return bool == true
        ? `<span class='badge badge-soft-success'>Activated <i class='fas fa-check-circle ml-1'></i></span>`
...
function isVerified(email_verified_at) {
    return email_verified_at
        ? `<span class='badge badge-soft-success'>Verified <i class='fas fa-check-circle ml-1'></i></span>`
