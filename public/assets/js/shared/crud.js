//===============================================================================
/**
 *  fetch all data and display as datatable
 * @param {*} dt
 * @param {*} route
 * @param {*} column
 * @param {*} filterable
 * @returns
 */
function c_index(dt, route, column, filterable = "") {
    if (filterable == true) {
        $(dt).DataTable().clear();
...
/**
 *  activate deactivate action on datatable
 * @param {*} id
 * @param {*} route_name
 * @param {*} value
 * @param {*} dt
...
function toggle_modal(modal, form, modal_title, buttons, opt = "") {
    ...
    $(modal_title[0]).html(
        `${modal_title[1]} <i class="fas fa-plus-circle ms-1"></i> `
    );
...
/**
 * handle store method from dynamic modal
 * @param {*} modal
 * @param {*} form
 * @param {*} modal_title
 * @param {*} buttons
...
/**
 * process edit method to dynamic modal
 * @param {*} modal
 * @param {*} form
 * @param {*} modal_title
 * @param {*} buttons
...
/**
 * handle update method from dynamic modal
 * @param {*} form
 * @param {*} dt
 * @param {*} route_name
 * @param {*} event
...
/**
 * handle delete record from datatable
 * @param {*} id
 * @param {*} routename
 * @param {*} dt
 * @param {*} opt
