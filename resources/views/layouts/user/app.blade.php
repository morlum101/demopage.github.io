                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                <img src="{{ asset('img/logo/logo.png') }}" alt="" height="24"> <span
                                    class="logo-txt">Las Flores</span>
                            </span>
                        </a>
                        ...
                        <a href="index" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <img src="http://localhost:8000/assets/images/logo-sm.svg" alt=""
                                    height="24"> <span class="logo-txt">Las Flores</span>
                            </span>
                        </a>
                    </div>
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a class="@if (Route::is('user.dashboard.index*')) active @endif"
                        ...
                        {{-- <li>
                            <a class="" href="#">
                                ...
                                <span data-key="t-dashboard">Tab</span>
                            </a>
                        </li> --}}
                        ...
                        {{-- <li>
                            <a href="javascript: void(0);" class="has-arrow">
                                ...
                                <span data-key="t-maps">Dropdown</span>
                            </a>
