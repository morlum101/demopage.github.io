            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-white footer-link-list">
                    <li class="text-white">
                        ...
                        101 Rizal St, Brgy Pob 2, Pagsanjan, 4008 Laguna, Philippines
                    </li>
                    <li>
                        <i class="fa fa-phone"></i>
                        <a class="text-decoration-none text-white" href="tel:+639761177391">+639761177391</a>
                    </li>
                    <li>
                        <i class="fa fa-envelope"></i>
                        <a class="text-decoration-none text-white" href="mailto: flowershop.lasflores@gmail.com">
                            flowershop.lasflores@gmail.com</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row pt-2">
                <div class="col-12">
                    <p class="text-center text-white">
                        Copyright © 2023 {{ config('app.name') }}
                    </p>
                </div>
            </div>
        </div>
